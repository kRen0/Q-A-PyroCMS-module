        ...
        <ul>
            <li>
                <label for="question"><?php echo lang('faq_question_label'); ?><span class="required-icon tooltip">*</span></label>
                    <textarea class="wysiwyg-simple" name="question" rows="10" cols="40"><?php echo $qa->question; ?></textarea>
            </li>
			<li>
                <label for="name"><?php echo lang('faq_author_name_label'); ?><span class="required-icon tooltip">*</span></label>
                <div class="input">
                    <input name="name" type="text" value="<?php echo $qa->author_name; ?>" />
                </div>
            </li>
			<li>
                ...
                <div class="input">
                    <input name="email" type="text" value="<?php echo $qa->author_email; ?>" />
                </div>
            </li>
            <li>
                <label for="authors"><?php echo lang('qa_a_author_label'); ?></label>
                <div class="input">
                    <?php echo form_dropdown('authors', $authors_options, (!empty($answ))?$answ->author_id:0); ?>
                </div>
            </li>
            <li>
                <label for="answer"><?php echo lang('qa_answer_label'); ?></label><br style="clear:both;">
                <textarea class="wysiwyg-simple" name="answer" rows="10" cols="40"><?php if(!empty($answ)) echo $answ->answer; ?></textarea>
            </li>
        </ul>
